...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |      |      |      | Alt  | Nav  | Lower| Space| Esc  | Space| Raise| Win  |      |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, NAV,     LOWER,   KC_SPC,  KC_ESC,  KC_SPC,  RAISE,   KC_LGUI, XXXXXXX, XXXXXXX, XXXXXXX  \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                      XXXXXXX, KC_EQL,  KC_CIRC, KC_PERC, KC_GRV,  KC_DEL,  \
      _______, KC_SLSH, KC_ASTR, KC_MINS, KC_PLUS, KC_DOT,                    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
      ),
