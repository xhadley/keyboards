...
[_QWERTY] = {
  ...
  {XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, LOWER,   KC_SPC,  RAISE,   KC_LGUI, XXXXXXX, XXXXXXX, XXXXXXX}
},
...
/* Raise
 * ,-----------------------------------------------------------------------------------.
 * | Tab  |  F1  |  F2  |  F3  |  F4  |   `  | Home | PgDn | PgUp | End  |PrntSc| Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|  F5  |  F6  |  F7  |  F8  |   \  | Left | Down |  Up  | Right| Esc  | Del  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  F9  |  F10 |  F11 |  F12 |   _  | Mute | Prev | Play | Next |      | Enter|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      | Alt  | Lower| Space| Raise| Win  |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
...
[_ADJUST] = {
  ...
  {XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX}
}
